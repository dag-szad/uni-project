...
function logIn() {
    if (emailInput.value === email && passwordInput.value === password) window.location.href = "home.html";
    else if (emailInput.value !== email || passwordInput.value !== password) window.alert("Invalid user data");
    else console.log("Some error");
}
submitButton.addEventListener("click", logIn);

},{}]},["icZzK","8lqZg"], "8lqZg", "parcelRequired356")
